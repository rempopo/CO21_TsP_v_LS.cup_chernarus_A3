...
MissionCondition1 = [ "WIN", { t14 inArea baseTrg }, "Трофей на месте" ];
MissionCondition2 = [ "WIPED", { call fnc_isAllDead }, "Все рома погибли", 30 ];
MissionCondition3 = [ "TGTWIPED", { !alive t14 }, "Танк утерян" ];